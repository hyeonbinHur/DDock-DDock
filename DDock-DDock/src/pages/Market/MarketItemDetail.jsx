    ...
    return (
        <>
            ...
            <div className={style.imageContainer}>
                {imageUrls[currentIndex-1] && <img src={leftArrow} className={style.left} onClick={currentIndexMinus}/>}
                
                <div className={style.userImageContainer}>
                    <img src={imageUrls[currentIndex]} className={style.mItemImage} />
                </div>
                {imageUrls[currentIndex+1] && <img src={rightArrow} className={style.right} onClick={currentIndexPlus}/>}
