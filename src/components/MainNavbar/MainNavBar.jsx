...
export default function Navbar() {
    ...
    return (
        <div className="static">
            ...
            {openChatRoom && (
                <div className="fixed w-screen border-l border-b h-screen bottom-0 no-scrollbar overflow-x-hidden rounded-t-md  bg-sky-50 z-50 lg:w-1/5 lg:h-3/5 lg:left-[77%]">
                    <PrivateChattingRoom />
                </div>
            )}
        </div>
